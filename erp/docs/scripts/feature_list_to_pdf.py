#!/usr/bin/env python3
"""Convert docs/功能清单.md to PDF via HTML + Chrome/Edge headless."""
...
DOCS = ROOT / "docs"
MD_FILE = DOCS / "功能清单.md"
HTML_FILE = DOCS / "功能清单.html"
PDF_FILE = DOCS / "功能清单.pdf"
...
def simple_md_to_html(md: str) -> str:
    ...
    html = "\n".join(out)
    html = re.sub(
        r"(<h1>Takealot ERP 功能清单</h1>\s*)<blockquote><p>(版本：[^<]+)</p></blockquote>",
