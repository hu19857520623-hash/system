export const MIGRATION_ORDER = [
  ...
  'migrate_role_office_warehouse.sql',
  'migrate_purchase_manager_role.sql',
  ...
  'migrate_async_io_result_detail.sql',
  'migrate_takealot_dest_warehouse.sql',
  'migrate_inbound_carton_specs.sql',
] as const
