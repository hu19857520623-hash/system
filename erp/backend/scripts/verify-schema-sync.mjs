...
const checks = [
  ...
  { table: 'inbound_order_item', columns: ['cost_rmb', 'sea_freight_per_unit', 'domestic_fee_per_unit'] },
  { table: 'inventory_location', columns: ['inbound_no', 'batch_no', 'cost_rmb', 'sea_freight_per_unit', 'unit_cost_rmb'] },
  { table: 'outbound_pick_allocation', columns: ['inbound_no', 'batch_no', 'unit_cost_rmb'] },
