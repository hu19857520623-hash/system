...
export class BillingController {
  ...
  @Get('charges')
  listCharges(@Query() q: PaginationDto & { customerId?: number; customerCode?: string; chargeType?: string; source?: string; status?: string; dateFrom?: string; dateTo?: string; destination?: string }) {
