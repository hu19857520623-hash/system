...
exports.PERM_GROUPS = [
    ...
    },
    {
        ...
        perms: [
            ...
            { id: 'purchase.finance_audit', label: '采购订单-财务审核/驳回' },
...
exports.ROLE_PERM_TEMPLATES = {
    系统管理员: [
        ...
        'purchase.view', 'purchase.create', 'purchase.assign', 'purchase.po_audit', 'purchase.finance_audit',
    ...
    采购主管: [
        ...
        'purchase.view', 'purchase.create', 'purchase.assign', 'purchase.po_audit',
        'logistics_wh.view', 'logistics_wh.receive', 'logistics_wh.manage',
        'create_inbound.view', 'create_inbound.create', 'create_inbound.label',
        'warehouse_location.view', 'warehouse_location.edit', 'warehouse_location.batch_create',
        'inbound.view', 'inbound.arrival_scan', 'inbound.receive', 'inbound.qc', 'inbound.putaway', 'inbound.handle_exception', 'inbound.confirm_diff',
    ...
    财务: [
        'products.view',
        'purchase.view', 'purchase.finance_audit',
        'cost.view',
        'billing.view', 'billing.generate', 'billing.manual',
        'receivable_payable.view', 'receivable_payable.manual',
...
exports.ROLE_DEFINITIONS = [
    ...
    { roleCode: 'ops_manager', roleName: '采购主管', templateKey: '采购主管', description: 'PO 审核、物流与入库协调' },
    ...
    { roleCode: 'finance', roleName: '财务', templateKey: '财务', description: '财务审核与结算' },
...
/** 可被分配为线索归属人的销售角色 */
exports.LEAD_ASSIGNEE_ROLE_CODES = ['cs', 'sales', 'sales_manager'];
/** 新建线索时强制归属当前登录人的销售角色（不含销售主管） */
exports.LEAD_SELF_ASSIGN_ROLE_CODES = ['cs', 'sales'];
