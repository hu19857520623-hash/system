...
exports.PERM_GROUPS = [
    ...
    },
    {
        ...
        perms: [
            ...
            { id: 'stocktake.view', label: '盘点管理-查看' },
            { id: 'stocktake.create', label: '盘点管理-创建' },
            { id: 'stocktake.count', label: '盘点管理-初盘/复盘' },
            { id: 'stocktake.approve', label: '盘点管理-审批调整' },
            { id: 'capacity.view', label: '仓库容量-查看' },
            { id: 'capacity.manage', label: '仓库容量-刷新预警' },
        ],
    },
    {
        label: '财务与运营',
