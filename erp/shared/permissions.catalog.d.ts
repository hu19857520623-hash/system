...
/** 可被分配为线索归属人的销售角色 */
export declare const LEAD_ASSIGNEE_ROLE_CODES: readonly ["cs", "sales", "sales_manager"];
/** 新建线索时强制归属当前登录人的销售角色（不含销售主管） */
export declare const LEAD_SELF_ASSIGN_ROLE_CODES: readonly ["cs", "sales"];
