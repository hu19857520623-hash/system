...
public final class PermissionConstants {
    ...
    private static final Map<String, List<String>> ROLE_PERM_TEMPLATES = Map.ofEntries(
            Map.entry("系统管理员", List.of(
                    ...
                    "outbound.pack", "outbound.ship", "anheng.view", "anheng.test",
                    "inventory_query.view", "inventory_query.detail", "inventory_query.adjust", "stocktake.view",
                    "stocktake.create", "stocktake.count", "stocktake.approve", "capacity.view",
                    "capacity.manage", "wms_reports.view", "inbound_fee.view", "inbound_fee.manage",
                    "pricing.view", "pricing.set", "pricing.sync_oms", "store_monitor.view",
                    "store_monitor.view_all", "store_monitor.manage", "store_monitor.assign", "cost.view",
                    "operating_ledger.view", "operating_ledger.manage", "billing.view", "billing.generate",
                    "billing.manual", "receivable_payable.view", "receivable_payable.manual", "budget_credit.view",
                    "budget_credit.create", "profit_analysis.view", "reports.view", "sync.view",
                    "sync.retry", "operation_log.view", "async_io.import", "async_io.export",
            ...
            Map.entry("采购主管", List.of(
                    ...
                    "mingrui.view", "mingrui.manage", "warehouse_location.view", "warehouse_location.edit",
                    ...
                    "inventory_query.detail", "inventory_query.adjust", "pricing.view", "cost.view",
            ...
            Map.entry("采购", List.of(
                    ...
                    "purchase.create", "purchase.mark_paid", "logistics_wh.view", "logistics_wh.receive",
                    "create_inbound.view", "create_inbound.create", "create_inbound.label", "mingrui.view",
                    "mingrui.manage", "warehouse_location.view", "inbound.view", "inventory_query.view",
                    "inventory_query.detail", "outbound.view", "outbound.create", "pricing.view",
                    "sync.view"
            )),
