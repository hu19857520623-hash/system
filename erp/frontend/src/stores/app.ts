...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'mingrui', name: '明瑞物流', badgeKey: 'mingrui' },
...
const NAV_ROUTE_MAP: Record<string, string> = {
  ...
  cost: '/finance-books/purchase',
  operating_ledger: '/finance-books/operating',
  finance_books: '/finance-books',
  sync: '/sync',
  operation_log: '/operation-logs',
  billing: '/billing',
  customers: '/customers',
  receivable_payable: '/finance-books/freight',
  reports: '/finance-books/analysis',
  store_monitor: '/store-monitor',
  profit_analysis: '/finance-books/analysis',
  ...
  actions: {
    ...
    canViewScreen(screenId: string): boolean {
      ...
      const permMap: Record<string, string | string[]> = {
        ...
        finance_books: [
          'cost.view',
          'operating_ledger.view',
          'receivable_payable.view',
