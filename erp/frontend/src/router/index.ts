...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'cost', redirect: '/finance-books/purchase' },
      { path: 'operating-ledger', redirect: '/finance-books/operating' },
      ...
      { path: 'supplier-freight', redirect: '/finance-books/freight' },
      { path: 'finance-books/:tab?', name: 'FinanceBooks', component: () => import('@/pages/FinanceBooksView.vue'), meta: { title: '账本分析', section: '财务' } },
      // 运营
      { path: 'reports', redirect: '/finance-books/analysis' },
      { path: 'profit-analysis', redirect: '/finance-books/analysis' },
