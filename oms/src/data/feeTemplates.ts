...
export const DEFAULT_PAYMENT_METHODS: PaymentMethod[] = [
  {
    ...
    enabled: true,
    sortOrder: 0,
    bankName: '中国工商银行 约翰内斯堡分行',
    accountName: '南非优选贸易（演示）',
    accountNumber: '6222 0212 3456 7890',
    branch: 'Johannesburg Main Branch',
    swiftCode: 'ICBKZAJJ',
    customText: '请在转账备注中填写客户编码（如 SA-2024-0086），到账后联系客服确认入账。\n工作日 09:00–17:00 处理，一般 1 个工作日内到账。',
    updatedAt: '2026-07-01',
  },
  {
    id: 'pm-alipay',
    ...
    sortOrder: 1,
    qrCodeUrl: '',
    accountId: 'sa-trade@example.com',
    customText: '扫码或转账至上述支付宝账号，备注填写客户编码。到账后 1 个工作日内入账。',
    updatedAt: '2026-07-01',
  },
  {
    id: 'pm-wechat',
    ...
    sortOrder: 2,
    qrCodeUrl: '',
    accountId: 'SA-Trade-OMS',
    customText: '微信扫码支付，备注填写客户编码。到账后 1 个工作日内入账。',
    updatedAt: '2026-07-01',
  },
]
