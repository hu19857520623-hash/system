...
private val translations = mapOf(
    "zh" to mapOf(
        ...
        "inbound" to "入库", "outbound" to "出库", "arrival" to "到仓扫描", "arrival_hint" to "扫入库单号后自动确认箱数",
        "receive" to "确认箱数", "receive_hint" to "扫箱唛和 SKU", "qc" to "清点", "qc_hint" to "扫 SKU 或条码累加实收",
        ...
        "scan_inbound" to "扫入库单号", "scan_carton" to "扫箱唛", "scan_carton_or_sku" to "扫箱唛或 SKU", "scan_sku" to "扫 SKU 或条码", "scan_sku_location" to "扫 SKU / 条码或库位", "scan_outbound" to "扫出库单号",
    ),
    "en" to mapOf(
        ...
        "inbound" to "Inbound", "outbound" to "Outbound", "arrival" to "Arrival scan", "arrival_hint" to "Scan inbound no., then confirm cartons",
        "receive" to "Confirm cartons", "receive_hint" to "Scan box label and SKU", "qc" to "Count", "qc_hint" to "Scan SKU or barcode to count received qty",
        ...
        "scan_inbound" to "Scan inbound order no.", "scan_carton" to "Scan box label", "scan_carton_or_sku" to "Scan box label or SKU", "scan_sku" to "Scan SKU or barcode", "scan_sku_location" to "Scan SKU, barcode or location", "scan_outbound" to "Scan outbound order no.",
    ),
    "af" to mapOf(
        ...
        "inbound" to "Inkomend", "outbound" to "Uitgaand", "arrival" to "Aankomsskandering", "arrival_hint" to "Skandeer bestellingnommer, dan kartonne",
        "receive" to "Bevestig kartonne", "receive_hint" to "Skandeer kartonetiket en SKU", "qc" to "Tel", "qc_hint" to "Skandeer SKU om hoeveelheid te tel",
        ...
        "scan_inbound" to "Skandeer inkomende bestellingnommer", "scan_carton" to "Skandeer kartonetiket", "scan_carton_or_sku" to "Skandeer kartonetiket of SKU", "scan_sku" to "Skandeer SKU", "scan_sku_location" to "Skandeer SKU of ligging", "scan_outbound" to "Skandeer uitgaande bestellingnommer",
    ),
)
