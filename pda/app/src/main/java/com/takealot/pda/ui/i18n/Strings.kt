...
private val translations = mapOf(
    "zh" to mapOf(
        ...
        "putaway" to "上架", "putaway_hint" to "扫 SKU 或条码再扫库位", "pick" to "拣货", "pick_hint" to "扫出库单，按库位拣货",
    ...
    "en" to mapOf(
        ...
        "putaway" to "Putaway", "putaway_hint" to "Scan SKU or barcode, then location", "pick" to "Pick", "pick_hint" to "Scan outbound order and pick by location",
    ...
    "af" to mapOf(
        ...
        "putaway" to "Wegpak", "putaway_hint" to "Skandeer SKU of strepieskode, dan ligging", "pick" to "Pluk", "pick_hint" to "Skandeer uitgaande bestelling en pluk per ligging",
